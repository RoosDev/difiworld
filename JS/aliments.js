...
function DisplayDynamicFood() {
    const tableProduct = document.querySelector("#productList");
    let lineProduct = "";
    const selectFoodValue = document.querySelector("#selectQuality").value;
...
function getlistTypeFiltered(type) {
    switch (type) {
        case "all":
